...
# %% auto #0
__all__ = ['bridge', 'app', 'rt', 'api_rows', 'api_expand', 'api_grid', 'home', 'rows', 'expand_route', 'grid_route', 'live',
           'inspector']
...
# %% ../nbs/05_fasthtml.ipynb #3c7c5b85
...
@rt('/')
def home():
    return Titled('paar', _profile_select(),
