...
# %% auto #0
__all__ = ['GRUV', 'Client', 'fmt_row', 'group_label', 'gruvbox_theme', 'InspectorApp', 'run', 'main']

# %% ../nbs/08_tui.ipynb #a46a1d9c
